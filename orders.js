...
/*  
    ...
    Create a method on the class called `updateStatus`. <<--function
...
let ticketA = new Ticket(['pizza', 'soda'], 1300, 786)
console.log(ticketA)

ticketA.updateStatus('ready') //<---- have to input string of new status when running the fxn on new created item
